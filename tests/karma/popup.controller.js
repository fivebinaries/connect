...
const handler = m => {
    ...
    if (type === UI.REQUEST_PERMISSION) {
        window.requestAnimationFrame(() => {
            const confirmButton = common.container.getElementsByClassName('confirm')[0];
            const cancelButton = common.container.getElementsByClassName('cancel')[0];
